...
# Admin_Part
    def add_food_item(self):    # Adding Food
        try:
    ...
    def edit_food_item(self):   # Edit Food item   
        try:
    ...
    def view_food_item(self):   #View Food Items
    ...
    def delete_food_item(self): # Delete Food Item
        try:
...
# User_Part
    ...
    def user_register(self):      # User Registration
        try:
            while True:
                
                print("<<< Please eneter a valid Email Id >>>")
    ...
    def user_login(self):       #User Login
        try:
            while True:
    ...
    def place_order(self):    #User Placing Order
        try:
            if len(self.food) != 0:
                menu = []
    ...
    def update_details(self):      # User update Profile
        try:
            while True:
...
def main():
    try:
        obj = Restaurant("The Fine Dine")
        print("\n||||/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\||||\n")
        print(f">>>>>>>>>>>>  Welcome To {obj.rest_name}  <<<<<<<<<<<<<\n")
        print("      ** Where every flavor tells a story. **            \n")
        print("||||\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/||||")
